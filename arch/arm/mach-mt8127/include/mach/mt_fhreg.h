...
#define fh_write8(reg,val)      mt65xx_reg_sync_writeb((val),(reg))
#define fh_write16(reg,val)     mt65xx_reg_sync_writew((val),(reg))
#define fh_write32(reg,val)     mt65xx_reg_sync_writel((val),(reg))
