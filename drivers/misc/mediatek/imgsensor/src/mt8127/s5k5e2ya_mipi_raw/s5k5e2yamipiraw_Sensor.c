...
static void S5K5E2YAGetAFMaxNumFocusAreas(UINT32 *pFeatureReturnPara32)
{	
    *pFeatureReturnPara32 = 0;    
    SENSORDB("S5K5E2YAGetAFMaxNumFocusAreas *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);
}

static void S5K5E2YAGetAEMaxNumMeteringAreas(UINT32 *pFeatureReturnPara32)
{     
    *pFeatureReturnPara32 = 0;    
    SENSORDB("S5K5E2YAGetAEMaxNumMeteringAreas *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);	
}

static void S5K5E2YAGetExifInfo(UINT32 exifAddr)
{
...
void S5K5E2YASetFlipMirror(kal_int32 imgMirror)
{
    ...
    switch (imgMirror)
    {
        case IMAGE_H_MIRROR://IMAGE_NORMAL:  bit0 mirror,   bit1 flip.
			S5K5E2YA_bytewrite_cmos_sensor(0x0101,0x02  ); //morror
            break;
        case IMAGE_NORMAL://IMAGE_V_MIRROR:
			S5K5E2YA_bytewrite_cmos_sensor(0x0101,0x03  ); 
            break;
        case IMAGE_HV_MIRROR://IMAGE_H_MIRROR:
			S5K5E2YA_bytewrite_cmos_sensor(0x0101,0x00  );   //morror +flip
            break;
        case IMAGE_V_MIRROR://IMAGE_HV_MIRROR:
			S5K5E2YA_bytewrite_cmos_sensor(0x0101,0x01  ); //flip
            break;
    }
}
...
UINT32 S5K5E2YASetTestPatternMode(kal_bool bEnable)
{
	...
	if(bEnable) 
	{
		S5K5E2YA_bytewrite_cmos_sensor(0x0601,0x02);
	}
	else        
	{
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
		...
		case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
			S5K5E2YAGetAFMaxNumFocusAreas(pFeatureReturnPara32);

			*pFeatureParaLen=4;
			break;

		case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
			S5K5E2YAGetAEMaxNumMeteringAreas(pFeatureReturnPara32);
		...
		case SENSOR_FEATURE_GET_EXIF_INFO:
			...
			S5K5E2YAGetExifInfo(*pFeatureData32);
			break;
