...
/*	switch(Mirror)
	{
		case GC2355_IMAGE_NORMAL://IMAGE_NORMAL:
		   GC2355_write_cmos_sensor(0x17,0x14);
		   GC2355_write_cmos_sensor(0x92,0x01);
		   GC2355_write_cmos_sensor(0x94,0x05);
		    break;
		case GC2355_IMAGE_H_MIRROR://IMAGE_H_MIRROR:
		   GC2355_write_cmos_sensor(0x17,0x15);
		   GC2355_write_cmos_sensor(0x92,0x01);
		   GC2355_write_cmos_sensor(0x94,0x04);
		    break;
		case GC2355_IMAGE_V_MIRROR://IMAGE_V_MIRROR:
		   GC2355_write_cmos_sensor(0x17,0x16);
		   GC2355_write_cmos_sensor(0x92,0x02);
		   GC2355_write_cmos_sensor(0x94,0x05);
		    break;
		case GC2355_IMAGE_HV_MIRROR://IMAGE_HV_MIRROR:
...
static void GC2355_Sensor_Init(void)
{
	...
	GC2355_write_cmos_sensor(0x17,0x17); // mirror 
...
{
	printk("zero %s\n ",__func__);
	GC2355_write_cmos_sensor(0x17,0x14); // mirror 
    GC2355_write_cmos_sensor(0x92,0x02);
	GC2355_write_cmos_sensor(0x94,0x04);
}
/*******end*************/
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_TEST_PATTERN:			 
			GC2355SetTestPatternMode((BOOL)*pFeatureData16);			//add by zero 
			break;
			/*SZ TCT xuejian.zhong add for CTS test */
