...
#endif
static void mtk_nand_micron_rrtry(struct mtd_info *mtd,flashdev_info_t deviceinfo, u32 feature, bool defValue)
{
...
static void mtk_nand_sandisk_19nm_rrtry(struct mtd_info *mtd,flashdev_info_t deviceinfo, u32 retryCount, bool defValue)
{
...
typedef u32 (*rrtryFunctionType)(struct mtd_info *mtd,flashdev_info_t deviceinfo, u32 feature, bool defValue);
...
static void mtk_nand_rrtry_func(struct mtd_info *mtd,flashdev_info_t deviceinfo, u32 feature, bool defValue)
{
 ...
 *
 ******************************************************************************/
static void mtk_nand_write_page_hwecc(struct mtd_info *mtd, struct nand_chip *chip, const uint8_t *buf, int oob_required)
{
