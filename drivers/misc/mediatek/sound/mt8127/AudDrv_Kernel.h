...
typedef struct
{
    ...
    volatile uint32 Suspend_AFE_HDMI_OUT_CON0;
    volatile uint32 Suspend_AFE_HDMI_OUT_BASE;
    volatile uint32 Suspend_AFE_HDMI_OUT_CUR;
    volatile uint32 Suspend_AFE_HDMI_OUT_END;
    volatile uint32 Suspend_AFE_SPDIF_OUT_CON0;
    volatile uint32 Suspend_AFE_SPDIF_BASE;
    volatile uint32 Suspend_AFE_SPDIF_CUR;
    volatile uint32 Suspend_AFE_SPDIF_END;
    volatile uint32 Suspend_AFE_HDMI_CONN0;
    volatile uint32 Suspend_AFE_8CH_I2S_OUT_CON;
    ...
    volatile uint32 Suspend_AFE_IEC_CFG;
    volatile uint32 Suspend_AFE_IEC_NSNUM;
    volatile uint32 Suspend_AFE_IEC_BURST_INFO;
    volatile uint32 Suspend_AFE_IEC_BURST_LEN;
    volatile uint32 Suspend_AFE_IEC_NSADR;
    volatile uint32 Suspend_AFE_IEC_CHL_STAT0;
    volatile uint32 Suspend_AFE_IEC_CHL_STAT1;
    volatile uint32 Suspend_AFE_IEC_CHR_STAT0;
    volatile uint32 Suspend_AFE_IEC_CHR_STAT1;
...
#define HDMI_MEM_TYPE_TO_MEMIF_BUFFER_TYPE(type) ((type)+MEM_HDMI_STEREO)
/*****************************************************************************
 *                       VARIBALE
 *****************************************************************************/
...
AFE_MEM_CONTROL_T     HDMI_STEREO_Control_context;
AFE_MEM_CONTROL_T     HDMI_MULTI_Control_context;
AFE_MEM_CONTROL_T     *HDMI_WORKING_Control_context = NULL;
...
Hdmi_Clock_Control   HDMI_Clk_Control;
